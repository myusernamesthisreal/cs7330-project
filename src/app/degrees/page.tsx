                ...
                <div className="z-10 max-w-3xl w-full items-center justify-between text-sm">
                    ...
                    {degrees.map((degree, index) => (
                        <div key={index} className="w-full p-4 border border-gray-300 rounded-lg mb-4">
                            ...
                            <button onClick={() => router.push(`/degrees/sections?name=${degree.name}&level=${degree.level}`)} className="bg-blue-500 w-full text-white rounded-lg p-2 mt-4">View Sections</button>
