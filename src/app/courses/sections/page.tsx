...
type SectionWithCourseDetails = Section & { courseName: string };
        ...
        <>
            <main className="flex min-h-screen flex-col items-center justify-between p-24">
                <div className="z-10 max-w-xl w-full items-center justify-between text-sm lg:flex lg:flex-col">
                    <h1 className="text-4xl font-bold text-center mb-4">Course Sections</h1>
                    ...
                    <div className="w-full">
                        {/* <input type="text" placeholder="End Semester" value={endSemester} onChange={(e) => setEndSemester(e.target.value)} className="p-2 border border-gray-300 text-black rounded-lg w-full mb-4" /> */}
